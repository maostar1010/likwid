...
const PciType pci_types[MAX_NUM_PCI_TYPES] = {
    ...
    [IMC]    = { "IMC",
                "The integrated Memory Controller provides the interface to DRAM and communicates to the "
              "rest of the uncore through the Home Agent."                                              },
    ...
    [IRP]    = { "IRP",
                "IRP is responsible for maintaining coherency for IIO traffic e.g. crosssocket P2P."    },
    [EDC]    = { "EDC",
                "The Embedded DRAM controller is used for high bandwidth memory on the Xeon Phi (KNL)." },
};
